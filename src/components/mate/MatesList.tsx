...
const MatesList = () => {
  return (
    <>
      <div className="m-[6%]">
        <div className="mb-[3%] text-[4vw] leading-[30.75px]">
          Mates: <span className="opacity-50">00</span>
        </div>
        {/*//* List */}
          ...
          <div className="flex justify-between items-center p-[4%] bg-secondary rounded-[2vw]">
            <div className="flex flex-col w-[70%]">
              ...
              <div className="text-[3vw] opacity-[50%]">
                0000-00-00 has joined your friends!
              </div>
        ...
        {/* <div className="mt-[40vw] flex flex-col justify-center items-center">
          ...
          <span className="text-[4vw] font-normal leading-[5vw] opacity-50">
